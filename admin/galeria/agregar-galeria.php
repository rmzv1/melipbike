    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="index.php"><i class="fa fa-link"></i> <span>Slider Inicio</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="galeria-proyecto.php">Agregar Imagenes</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="galeria-proyecto.php"><i class="fa fa-link"></i> <span>Slider Inicio</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
